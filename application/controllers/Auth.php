...
class Auth extends CI_Controller
{
  ...
  private function _sendEmail($token, $type)
  {
    $config = [
      ...
      'smtp_user' => 'linkstar321@gmail.com',
      'smtp_pass' => 'sanas123',
      'smtp_port' => 465,
      'mailtype' => 'html',
      'charset' => 'utf-8',
    ...
    $this->email->from('linkstar321@gmail.com', 'hmos9c');
  ...
  public function changePassword()
  {
    ...
    $this->form_validation->set_rules('password1', 'Password', 'trim|required|min_lengrh[3]|matches[password2]');
    $this->form_validation->set_rules('password2', 'Repeat Password', 'trim|required|min_lengrh[3]|matches[password1]');
    if($this->form_validation->run()==false){
